  ...
  const handleFormSubmit = async (event) => {
    ...
    try {
      ...
      const roomData = items.map((room) => ({
        roomId: room.restroom_id.value,
        name: room.restroom_name.value,
        street: room.restroom_street.value,
        city: room.restroom_city.value,
        state: room.restroom_state.value,
        accessible: room.restroom_accessible.value
      }));
